...
const section6wrapper = document.querySelector(".section-6-wrapper");
...
const pageController = () => {
  ...
  if (counter1 === 6) {
    ...
    counter2 = 1;
    section1wrapper.style.transform = "scale(1)";
    section6wrapper.style.transform = "scale(1.5)";
    progressCounter();
    bool = false;
  }
  ...
  if (counter1 === -1) {
    Array.from(sections).forEach((section) => {
      if (section.classList[0] === "section-6") {
        return;
      }
    ...
    section6wrapper.style.transform = "scale(1)";
    progressCounter();
    bool = false;
  }
  progressCounter();
