...
function gameLoop(pacman, ghosts) {
    gameBoard.moveCharacter(pacman); // Move pacman
    checkCollision(pacman, ghosts); // Make collision after move pacman and ghost
    ghosts.forEach(ghost => { gameBoard.moveCharacter(ghost) }); // Move ghosts
    checkCollision(pacman, ghosts); // Make collision after move pacman and ghost
    ...
    // Chack if all dots have been eaten
